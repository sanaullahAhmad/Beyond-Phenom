...
(function($) {
  ...
  var color_names;
  var createPaletteElement = function(element, _aaColor, _aaName) {
  ...
  var Palette = function(element, options) {
    ...
    createPaletteElement(element, options && options.colors || aaColor, options && options.names);
    attachEvent(this);
  };
  $.fn.extend({
