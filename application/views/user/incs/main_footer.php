...
<script type="text/javascript" src="<?php echo base_url('assets/js/user/colpick.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/user/script.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/user/bootstrap-colorpalette.js'); ?>"></script>
</html>