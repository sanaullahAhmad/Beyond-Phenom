...
<div class="row">
    <div class="col-md-7">
        ...
        <div class="form-group">
            <label for="int">Product Type/ Category <?php echo form_error('categoryId') ?></label>
...
*/                    foreach ($product_categories as $category)
	    ...
	    <div class="form-group">
            ...
            <select class="form-control" name="patternFileId" id="patternFileId" required>
            <option value="" >Select Size</option>
                ...
                if($product_sizes)
                {
                    ...
                    {
                        ?>
                        <option value="<?php echo $size->sizeId; ?>" category="<?=$size->categoryId?>" <?php if($size->sizeId==$patternFileId){ echo "selected";} ?> ><?php echo $size->sizeTitle; ?></option>
                        <?php
                    }
                }
        ...
        <? if(isset($_SERVER['HTTP_REFERER'])) $redirect = $_SERVER['HTTP_REFERER']; else $redirect = site_url('product_size_pattern_layers'); ?> 
	    <a href="<?php echo $redirect; ?>" class="btn btn-default">Cancel</a>
	</form>
    </div>
    </div>
</div>