        ...
        <div class="navbar-header">
          ...
          <ul class="dropdown-menu">
              ...
              <a href="<?php echo base_url('index.php/products'); ?>"><i class="icon-folder-open icon-white"></i> Products</a>
                <ul> -->
                  <li>
                    <a href="<?=site_url('product_categories')?>">Product Types</a>
                   <!-- <a href="<?/*=site_url('product_sizes')*/?>">Product Sizes</a>-->
                      <!-- <a href="<?=site_url('product_size_pattern_layers')?>">Product Printable Size Layers</a>
                      <a href="<?=site_url('user_orders')?>">Orders</a>-->
                      <!--<a href="<?/*=site_url('order_product')*/?>">Order Products</a>-->
              ...
              <li><a href="<?=site_url('user_orders')?>"><i class="icon-th icon-white"></i> Orders</a></li>
                <li><a href="<?php echo base_url('patterns'); ?>"><i class="icon-th icon-white"></i> Patterns</a></li>
              <!--<li><a href="<?php /*echo base_url('index.php/fonts'); */?>"><i class="icon-th icon-white"></i> Fonts</a></li>-->
              <li><a href="<?php echo base_url('admins'); ?>"><i class="icon-th icon-white"></i> Admins</a></li>
                <li><a href="<?php echo base_url('manufacturers'); ?>"><i class="icon-th icon-white"></i> Manufactures</a></li>
              <li><a href="<?php echo base_url('myadmin/logout'); ?>"><i class="icon-lock icon-white"></i> Logout</a></li>
