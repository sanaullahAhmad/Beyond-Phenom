...
/**
 *
 * A PHP class that acts as wrapper for the First data API
 *
...
class Firstdata
{
    ...
    public function process_payment( $order ) {
        ...
        switch(dirname(__FILE__)){
            case 'E:\xampp\htdocs\beyondphenom\application\libraries';
                $keyfile      = 'E:\xampp\htdocs\beyondphenom\FIRSTDATA.pem';
                break;
            case '/home/admin/web/pakipreneurs.com/public_html/beyondphenom/application/libraries';//http://5.9.229.251/beyondphenom/
                $keyfile      = '/home/admin/web/pakipreneurs.com/public_html/beyondphenom/FIRSTDATA.pem';
                break;
            default://http://shop.beyondphenom.com/
                $keyfile      = '/home/beyondph/public_html/FIRSTDATA.pem';
                break;
        }
        $args = array(
            'host'          =>  'secure.linkpt.net',//'staging.linkpt.net',
            'port'          =>  '1129',
            'keyfile'       =>  $keyfile,
            'configfile'    =>  '1001303750',
            'cardnumber'    =>  $_POST[ 'firstdata-account-number' ],
            'cvmvalue'      =>  $_POST[ 'firstdata-cvv' ],
            'cvmindicator'  =>  'provided',
            'cardexpmonth'  =>  $_POST[ 'firstdata-exp-month' ],
            'cardexpyear'   =>  substr( $_POST['firstdata-exp-year'], -2, 2 ),
            'chargetotal'   =>  $_POST['get_total'],
            'shipping'      =>  $_POST['get_total_shipping'],
            'ordertype'     =>  'SALE',
...
#			curl_setopt ($ch, CURLOPT_SSL_VERIFYPEER, 0);
            ...
            //echo "<pre>";var_dump($host,$xml,$key);
